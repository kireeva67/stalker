/*
  ...
  - Added the required column `poll_id` to the `Links` table without a default value. This is not possible if the table is not empty.
...
CREATE UNIQUE INDEX "Links_poll_id_key" ON "Links"("poll_id");
